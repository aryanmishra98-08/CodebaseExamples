...
def ensure_folder(folder_name):
    """
    Ensures that a folder exists in the current working directory.
    ...
    if not os.path.isdir(folder_path):
        try:
            ...
            print(f"Folder Creation Failed ({folder_name}) - {e}")

    return folder_path


# Create (or verify) logs and data directories
logs_dir = ensure_folder("logs")
data_dir = ensure_folder("data")
